  ...
  return (
    <div className="w-screen min-h-screen relative pb-20 px-3 md:px-6 bg-white">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-[minmax(0,640px)_350px] gap-8">
        {/* ⇦ FEED SECTION */}
        <div className="min-h-screen md:-ml-8 lg:-ml-12 xl:-ml-16 transition-all duration-300">
          <PostList />
        </div>

        {/* 🧱 RIGHT SIDEBAR */}
        <div className="hidden md:flex flex-col gap-6 mt-10 pr-2 sticky top-10 h-fit">
